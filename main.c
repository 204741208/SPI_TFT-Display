...
ST7735_SetRotation(0);
    ST7735_WriteString(0, 0, "KERNEL", Font_7x10, RED,BLACK);
    HAL_Delay(1000);
    fillScreen(BLACK);

    ST7735_SetRotation(0);
    ST7735_WriteString(0, 0, "MASTERS", Font_7x10, GREEN,BLACK);
    HAL_Delay(1000);
    fillScreen(BLACK);
    /* USER CODE BEGIN 3 */
  }
...
{
  /* USER CODE BEGIN 6 */ Study the ST7735 TFT module datasheet to understand specifications, communication protocols, and register programming.
